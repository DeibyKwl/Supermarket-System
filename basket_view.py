...
entry_barcode.bind('<Return>', lambda event: basket_services.add_product_basket(entry_barcode, text_box, cost_box, total_cost_box))
...
clear_button.config(command=lambda: basket_services.clear_product_basket(text_box, cost_box, total_cost_box))
